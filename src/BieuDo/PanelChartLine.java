...
public class PanelChartLine extends javax.swing.JPanel {
    ...
    private final List<ThongKeDoanhThu> list;
    ...
    protected void paintComponent(Graphics grphcs) {
        if (list.size() > 1) {
            ...
            int x = margin;
            for (ThongKeDoanhThu data : list) {
                double location = data.getSum()* height / max;
    ...
    public void addItem(ThongKeDoanhThu data) {
        list.add(data);
        repaint();
    }
