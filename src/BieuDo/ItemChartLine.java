...
public class ItemChartLine extends javax.swing.JPanel {
    ...
    public ItemChartLine(ThongKeDoanhThu data) {
        initComponents();
        setOpaque(false);
        DecimalFormat df = new DecimalFormat("# Bệnh Nhân,##0.##");
        lbName.setText(data.getPhong());
        lbValues.setText(df.format(data.getSum()));
